...
// ===== INPUT NOMOR BOT =====
const botNumber = readline.question("Número do bot (62xxx): ")
console.log(chalk.green("[✓] O bot será executado:"), botNumber)
...
╚═╝  ╚═╝╚═════╝╚═════╝
`))
  console.log(chalk.green(">>> ROOT RAGERS BOT PRONTO <<<"))
  hackerScroll()
}
...
async function startBot(){
  ...
  sock.ev.on("connection.update", update=>{
    ...
    if(qr){
      console.log(chalk.yellow("[📌] Digitalize o seguinte QR no WhatsApp:"))
